        ...
        let schema = Schema::new(vec![
            Field::new(
                ...
                DataType::Struct(Fields::from(vec![
                    ...
                    Field::new(
                        "c12",
                        DataType::Struct(Fields::from(vec![Field::new("c121", DataType::Utf8, false)])),
                        false,
                    ),
                ])),
                false,
...
"#
    ...
    fn write_struct_with_list_field() {
        ...
        let a_list_data = ArrayData::builder(field_c1.data_type().clone())
            ...
            .add_child_data(a_values.to_data().clone())
...
"#
    ...
    fn write_list_of_struct() {
        ...
        let c1_list_data = ArrayData::builder(field_c1.data_type().clone())
            .len(3)
            .add_buffer(c1_value_offsets)
            .add_child_data(struct_values.to_data().clone())
...
"#
    ...
    fn json_list_roundtrip() {
        ...
        {"list": [null]}
        "#;
        let ints_struct = DataType::Struct(Fields::from(vec![Field::new("ints", DataType::Int32, true)]));
