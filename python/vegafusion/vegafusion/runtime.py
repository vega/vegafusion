...
class VegaFusionRuntime:
    ...
    def pre_transform_spec(self, spec, local_tz, format_tz=None, row_limit=None, inline_datasets=None):
        """
        ...
        :param format_tz: Name of timezone (e.g. 'America/New_York') that local datetime
