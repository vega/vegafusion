...
# -*- coding: utf-8 -*-
#
# vegafusion_jupyter documentation build configuration file
#
...
_version_py = os.path.join(repo, 'vegafusion_jupyter', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'vegafusion_jupyter.tex', 'vegafusion_jupyter Documentation',
     'Jon Mease', 'manual'),
]
...
man_pages = [
    (master_doc,
    'vegafusion_jupyter',
    'vegafusion_jupyter Documentation',
     [author], 1)
]
