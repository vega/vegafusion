...
# -*- coding: utf-8 -*-
#
# altairfusion_jupyter documentation build configuration file
#
...
project = 'altairfusion_jupyter'
copyright = '2021, Jon Mease'
author = 'Jon Mease'
...
_version_py = os.path.join(repo, 'altairfusion_jupyter', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'altairfusion_jupyterdoc'
...
latex_documents = [
    (master_doc, 'altairfusion_jupyter.tex', 'altairfusion_jupyter Documentation',
     'Jon Mease', 'manual'),
]
...
man_pages = [
    (master_doc,
    'altairfusion_jupyter',
    'altairfusion_jupyter Documentation',
     [author], 1)
]
