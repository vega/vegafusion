...
impl TransformTrait for Stack {
    ...
    async fn eval_sql(
        ...
        let offset = StackOffset::from_i32(self.offset).expect("Failed to convert stack offset");
        let dataframe = match offset {
            StackOffset::Zero => eval_zero_offset_sql(
                self,
                dataframe,
                input_fields.as_slice(),
                &alias0,
            ...
            StackOffset::Normalize => eval_normalize_center_offset_sql(
                self,
                dataframe,
                input_fields.as_slice(),
                &alias0,
            ...
            StackOffset::Center => eval_normalize_center_offset_sql(
                self,
                dataframe,
                input_fields.as_slice(),
                &alias0,
...
fn eval_normalize_center_offset_sql(
    stack: &Stack,
    dataframe: Arc<SqlDataFrame>,
    input_fields: &[String],
    alias0: &str,
